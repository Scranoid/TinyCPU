                ...
                ForEach(Array(cells.enumerated()), id: \.0) { idx, instr in
                    ...
                    VStack(spacing: 6) {
                        Text(String(format: "%02d", idx))
                            .font(.caption)
                            .foregroundColor(theme.isDarkMode ? .white.opacity(0.75) : .black.opacity(0.75))
                        ...
                        Text(instr.name)
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 10)
                                    .stroke(
                                        isActive ? Color.accentBlue.opacity(0.6) :
                            ...
                            .shadow(color: isActive ? Color.accentBlue.opacity(0.35) : .clear, radius: isActive ? 6 : 0)
                    }
                    .padding(4)
